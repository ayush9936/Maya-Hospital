...
const [itemsPerPage, setItemsPerPage] = useState(10)
  ...
  useEffect(()=>{
fetch("https://hospitalapi.projectupdate.in/api/getDoctorDetails")
    ...
    <div className="card radius-10 ">
        <div className="card-body">
          <div className="d-flex align-items-center">
            <div>
              <h6  style={{color:"#7163bafc"}}>Doctors Details</h6>
            </div>
           
          </div>
          <div className="table-responsive">
            <table className="table align-middle mb-0 table-bordered table-hover">
              <thead className="" style={{backgroundColor:"#7163bafc",color:"white"}}>
                <tr>
                  <th>Serial No.</th>
                  <th>Doctor Name</th>
                  <th>Phone</th>
              ...
              <tbody>
                {currentItems.map((item)=>(
                  ...
                  {item.doctor_name}
                   ...
                   <td><button className='btn btn-light border-success btn-sm'>Edit</button></td>
                 </tr>
                ))}
